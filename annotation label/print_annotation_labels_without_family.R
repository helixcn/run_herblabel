...
file.copy(from = "Annotation_label_data.xlsx", to = paste("xlsx history/", dat_tag, "_Annotation_label_data.xlsx", sep = ""))
...
file.copy(from = "annotation_labels_to_print.rtf", to = paste("RTF history/", dat_tag, "_annotation_labels_to_print.rtf", sep = ""))
